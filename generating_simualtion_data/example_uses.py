from generate_parity_series import generate_parity_series
from generating_simualtion_data.find_switching_rate import find_static_switching_rate_clean_series, find_dynamic_switching_rates_noisy_series
import numpy as np
